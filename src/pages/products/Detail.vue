          ...
          <CardContent class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div class="space-y-1.5">
              ...
              <Input
                ...
                :model-value="productStore.product.title || '-'"
                disabled
              />
            </div>
            <div class="space-y-1.5">
              ...
              <Input
                ...
                :model-value="productStore.product.price || 0"
                disabled
              />
            </div>
            <div class="space-y-1.5">
              ...
              <Input
                ...
                :model-value="productStore.product.category || '-'"
                disabled
              />
            </div>
            <div class="space-y-1.5">
              ...
              <Input
                ...
                :model-value="productStore.product.image || '-'"
                disabled
              />
            </div>
            <div class="sm:col-span-2 space-y-1.5">
              ...
              <Textarea
                ...
                :model-value="productStore.product.description || '-'"
                disabled
              />
            </div>
          </CardContent>
